...
export function Button({
  ...
  const variantClasses = {
    ...
    outline: "bg-black hover:bg-off-white/10 text-text-primary border-off-white/30",
    dark: "bg-black text-brutal-red border-border hover:border-brutal-red",
    muted: "bg-near-black text-text-primary border-border hover:border-brutal-red [&_svg]:text-brutal-red",
