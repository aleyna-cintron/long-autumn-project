...
export const bandMembers: BandMember[] = [
  {
    name: 'Conor Moran',
    role: 'Drums',
    imageUrl: '/band-cards/conor.webp',
  ...
  },
  {
    name: 'Johnny Mark',
    role: 'Lead Vocals',
    imageUrl: '/band-cards/johnmark.webp',
  ...
  },
  {
    name: 'Kolbe Maloney',
    role: 'Bass Guitar',
    imageUrl: '/band-cards/kolbeBike.webp',
