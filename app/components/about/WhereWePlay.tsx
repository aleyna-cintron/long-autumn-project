      ...
      <div className="relative z-10">
        ...
        <div className="flex flex-wrap justify-center gap-3 md:gap-4 2xl:gap-5 3xl:gap-6 max-w-3xl 2xl:max-w-4xl 3xl:max-w-5xl 4xl:max-w-6xl mx-auto">
          {regions.map(region => (
            <div
              key={region}
              className="px-4 py-2 md:px-6 md:py-3 2xl:px-8 2xl:py-4 3xl:px-10 3xl:py-5 bg-black/40 border border-gray-500 rounded-full text-text-secondary text-xs md:text-sm 2xl:text-base 3xl:text-lg 4xl:text-lg
                hover:border-red-500 hover:text-text-primary hover:bg-red-900/30 transition-all duration-300"
            >
              {region}
            </div>
          ))}
