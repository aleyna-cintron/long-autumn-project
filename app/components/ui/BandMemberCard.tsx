...
export default function BandMemberCard({ name, role, imageUrl, bio }: BandMemberCardProps) {
  return (
    <div className="relative group">
      ...
      <div className="absolute -bottom-4 left-0 right-0 mx-4 bg-black/95 backdrop-blur-md p-6 lg:p-8 rounded-lg border-2 border-brutal-red/40 shadow-2xl shadow-brutal-red/20 transform translate-y-full opacity-0 group-hover:translate-y-0 group-hover:opacity-100 transition-all duration-500 ease-out z-30">
