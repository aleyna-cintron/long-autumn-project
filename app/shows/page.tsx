            ...
            <section className="py-20">
                ...
                {upcomingShows.length === 0 ? (
                    ...
                    <div className="bg-gray border border-gray-800 rounded-lg p-12 text-center">
                        <p className="text-3xl md:text-4xl 3xl:text-5xl font-bold text-gray-500 mb-2">TBD</p>
                        <p className="text-gray-400 text-base md:text-lg 3xl:text-xl">No upcoming shows scheduled at this time. Check back soon!</p>
                    </div>
                ) : (
                    /* Show Listings */
                    ...
                    <div className="mt-12 p-8 text-center rounded-sm max-w-4xl 3xl:max-w-5xl mx-auto">
                        <h3 className="text-lg md:text-xl lg:text-2xl 3xl:text-2xl 4xl:text-3xl font-bold uppercase tracking-widest text-white mb-4">
